                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="{{route('admin.product.add', [0])}}" data-toggle="modal" data-id="0" data-backdrop="static" class="btn btn-pill btn-success"><i class="fa fa-plus"></i>&nbsp;Add</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($data as $row)
                                        <tr id="tr{{ $row->id }}">
                                            ...
                                            <td>
                                                <span class="cursor"> <a href="{{ route('admin.product.add', [$row->id]) }}" title="Edit"  class="btn btn-info btn-circle btn-sm m-r-5"><i class="fa fa-edit"></i></a> </span>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
