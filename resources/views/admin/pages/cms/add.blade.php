                        ...
                        <div class="card border-primary">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="ccnumber">Nice Name</label>
                                            <input class="form-control" name="nice_name" maxlength="50" type="text" value="{{ @$data_value->nice_name }}" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                         <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="ccnumber">Content</label>
                                            <textarea rows="10" name="content" class="form-control" id="editor">
                                                {{ @$data_value->content }}
                                            </textarea>
                                        </div>
                                    </div>
